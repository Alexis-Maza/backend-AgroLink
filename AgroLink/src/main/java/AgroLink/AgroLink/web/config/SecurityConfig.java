...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // ← tu versión
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/public/**").permitAll()           // ← de tu compañero
                        .requestMatchers("/productos/**").permitAll()        // ← tuya
